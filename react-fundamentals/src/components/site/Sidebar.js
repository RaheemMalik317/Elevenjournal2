...
import FuncationalComponentDemo from '../concepts/FunctionalComponents/FunctionalComponentDemo';
        ...
        <div className='sidebar'>
            ...
            <div className='sidebar-route'>
                <Switch>
                    ...
                    <Route exact path='/functionalcomponent'><FuncationalComponentDemo /></Route>
