    ...
    return(
        <div className='main'>
            <div className='mainDiv'>
                ...
                <FunctionalComponent string='Andrea 3000 will always be the Goat!' function={toggleBackgroundColor} selectedStyle ={backgroundColor} />
                <FunctionalComponent string='Who hates cooking?' function={toggleBorderRadius} selectedStyle = {borderRadius} />
                <FunctionalComponent string='Anime is life!' function={toggleBorderStyle} selectedStyle = {borderStyle}/>
            </div>
        </div>
        </div>
    )
